...
export default function Autocomplete() {
  ...
  return (
    <Root>
      <div {...getRootProps()}>
        <Label {...getInputLabelProps()}>Cuisines</Label>
        <InputWrapper
          ref={setAnchorEl}
          ...
          <input name="cuisines" {...getInputProps()} />
        </InputWrapper>
      </div>
...
const top100Films = [
  { title: "Turkish", year: 1994 },
  { title: "Korean", year: 1972 },
  { title: "Chinese", year: 1974 },
  { title: "Eastern", year: 2008 },
  { title: "European", year: 1957 },
  { title: "Caribbean", year: 1993 },
  { title: "Thai", year: 1994 },
  {
    title: "Indian",
    year: 2003,
  },
  { title: "Georgian", year: 1966 },
